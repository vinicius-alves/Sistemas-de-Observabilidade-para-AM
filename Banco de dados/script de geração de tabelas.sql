...
CREATE TABLE IF NOT EXISTS `mydb`.`EvaluationSpecification` (
  `idEvaluationSpecification` INT NOT NULL AUTO_INCREMENT,
  `idEvaluationProcedure` INT NOT NULL,
  `idTask` INT NOT NULL,
  PRIMARY KEY (`idEvaluationSpecification`),
  INDEX `fk_EvaluationSpecification_EvaluationProcedure1_idx` (`idEvaluationProcedure` ASC) VISIBLE,
  INDEX `fk_EvaluationSpecification_Task1_idx` (`idTask` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`TaskParameter`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`TaskParameter` (
  `idTaskParameter` INT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(45) NULL,
  `name` VARCHAR(45) NULL,
  `idRun` INT NOT NULL,
  PRIMARY KEY (`idTaskParameter`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`ModelParameter` (
  `idModelParameter` INT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(45) NULL,
  `name` VARCHAR(45) NULL,
  `idRun` INT NOT NULL,
  PRIMARY KEY (`idModelParameter`),
  INDEX `fk_ModelParameter_Run2_idx` (`idRun` ASC) VISIBLE,
  CONSTRAINT `fk_ModelParameter_Run2`
    FOREIGN KEY (`idRun`)
    REFERENCES `mydb`.`Run` (`idRun`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)

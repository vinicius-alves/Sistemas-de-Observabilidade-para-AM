...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`TaskType` (`idTaskType`, `taskType`) VALUES (1, 'Classification');
INSERT INTO `mydb`.`TaskType` (`idTaskType`, `taskType`) VALUES (2, 'Regression');

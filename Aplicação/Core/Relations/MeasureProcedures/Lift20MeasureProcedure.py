...
class Lift20MeasureProcedure(EvaluationProcedure):
    ...
    def evaluate(self, **kwargs):
        ...
        value =  self.lift_at_k(y_truth, y_pred_proba, k=0.20)
        if np.isnan(value):
            value =None
        return MeasureValue(measure = Measure(name='Lift 20') , value= value, evaluationProcedure = self)